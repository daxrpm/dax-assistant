...
_ES_EN_KEYWORDS: dict[str, list[str]] = {
    ...
    "notificaciones": ["notifications", "read", "phone"],
    "llamada": ["call", "dial", "phone"],
    "llamar": ["call", "dial", "phone"],
    "sms": ["sms", "message", "compose", "phone"],
    "teléfono": ["phone", "android", "device"],
    "telefono": ["phone", "android", "device"],
